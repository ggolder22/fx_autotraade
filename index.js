    ...
    //  }
     ...
     try {
      ...
      //for (let i = 1; i < 4; i++) {
        ...
        result1 = await connection.createMarketBuyOrder(tikcer, (Number(positionSize))*0.5, +sl, +tp1);
        result2 = await connection.createMarketBuyOrder(tikcer, (Number(positionSize))*0.3, +sl, +tp2);
        result3 = await connection.createMarketBuyOrder(tikcer, (Number(positionSize))*0.2, +sl, +tp3);
      //}
